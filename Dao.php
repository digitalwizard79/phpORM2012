...
abstract class PhpORM_Dao
{
     ...
     * @return array
     */
    abstract public function fetchAll($where = null, $orderBy = null);
     ...
     * @return array
     */
    abstract public function fetchAllBy($key, $value = null, $orderBy = null);
     ...
     * @return array
     */
    abstract public function fetchOneBy($key, $value = null, $orderBy = null);
